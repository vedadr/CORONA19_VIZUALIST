...
def variable_description(covid_data, config):
    ...
    # var name, var label, formatting, color palette, agg method, agg string, buuble size hint, filter rule
        variable_value_desc = [[each_date + '_cases', 'Cumulative Number of Confirmed Cases on ' + each_date.replace('_', ' '), '9', 'teal', '1', 'Add', '1', 'COVID19Cases'],
                               [each_date+'_deaths', 'Cumulative Number of Deaths on ' + each_date.replace('_', ' '), '9', 'teal', '1', 'Add', '1', 'COVID19Deaths'],
                               [each_date + '_daily_change_cases', 'Change in Cumulative Cases from Previous Day', '9', 'teal', '1', 'Add', '1', ''],
                               [each_date + '_daily_change_confirmed_cases', 'Daily Change Confirmed Cases', '9', 'teal', '1','Add', '1', ''],
                               [each_date + '_weekly_change_confirmed_cases', 'Change in Cumulative Confirmed Cases from Previous Week', '9', 'teal', '1', 'Add', '1', ''],
                               [each_date + '_monthly_change_confirmed_cases', 'Change in Cumulative Confirmed Cases from Previous Month', '9',
                                'teal', '1',
                                'Add', '1', ''],
                               [each_date + '_daily_change_deaths', 'Change in Cumulative Number of Deaths from Previous Day', '9', 'teal', '1', 'Add', '1', ''],
                               [each_date + '_weekly_change_deaths', 'Change in Cumulative Deaths from Previous Week', '9', 'teal', '1', 'Add', '2', ''],
                               [each_date + '_monthly_change_deaths', 'Change in Cumulative Deaths from Previous Month', '9', 'teal', '1', 'Add', '2', ''],
                               [each_date + '_daily_change_confirmed_cases_percent', 'Percent of Daily Change Confirmed Cases', '2', 'cold n hot', '1', 'Add', '1', 'COVID19Daily_Change_Confirmed_Cases_Percent'],
                               [each_date + '_daily_change_deaths_percent', 'Percent of Daily Change Deaths', '2', 'cold n hot', '1', 'Add', '1', ''],
                               [each_date + '_daily_change_confirmed_cases_doubling_time',
                                'Daily Change in Confirmed Cases By Doubling Time', '11', 'teal', '1', 'Add', '1', ''],
                               ...
                               [each_date + '_daily_change_in_growth_confirmed_cases_percent',
                                'Percent Growth in Daily Change of Confirmed Cases from Previous Day', '2', 'cold n hot', '1', 'Add', '0', 'COVID19Daily_Change_In_Growth_Confirmed_Cases_Percent'],
                               [each_date + '_percent_pop_confirmed_cases', 'Cumulative Percent of Population with Confirmed Cases', '2',
                                'cold n hot', '1', 'Add', '1', 'COVID19Percent_Pop_Confirmed_Cases'],
                              ...
                              [each_date + '_percent_pop_deaths', 'Cumulative Percent of Population Deaths', '9', 'teal', '1',
                               ...
                               [each_date + '_daily_change_in_growth_deaths_percent',
                                'Percent Growth in Daily Change of Deaths from Previous Day', '2', 'cold n hot', '1', 'Add', '1', 'COVID19Daily_Change_In_Growth_Deaths_Percent'],
                               ...
                               [each_date + '_deaths_rate_per_100k', 'Cumulative Death Rate per 100,000', '10', 'teal', '8', 'Rate|||100000', '1', 'COVID19Deaths_Rate_Per_100k']
                               ]
